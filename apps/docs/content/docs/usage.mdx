...
<Callout>
**Notes: ** When changing the `packages/example-library` folder name, you need to update the following files too from:
</Callout>
...
<Callout>
**Notes: ** If you want to use more `react-native-reusables` components you can install them through the [CLI](https://reactnativereusables.com/docs/cli) inside `packages/your-library`
</Callout>
